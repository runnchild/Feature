...
open class BaseBinderAdapter(list: MutableList<Any>? = null) :
    ...
    @Keep
    fun setDiffNewData(list: List<Any>?) {
        super.setNewDiffData(object : BaseQuickDiffCallback<Any>(list) {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        ...
        if (mBinderArray[holder.itemViewType] != null) {
            bindClick(holder)
            bindChildClick(holder, holder.itemViewType)
        }
    }
    ...
    override fun convertPayloads(helper: BaseViewHolder, item: Any, payloads: MutableList<Any>) {
        getItemBinder(helper.itemViewType).convert(helper, item, payloads)
    }
